...
import ProfileVolunteersTemplate from '@/components/templates/ProfileVolunteersTemplate';
...
const defaultTableData = tableWiseDefaultData?.profilesVolunteersDefaultData;

const ProfileVolunteersPage = () => {
  const {
    appliedFilter,
    tableData,
    totalCount,
    ...
    defaultTableData,
    tableRelations?.profilesVolunteersPage
  );
  ...
  return (
    <ModalWrapper
      ...
      uploadFormInputsWithLabelAndKey={
        uploadFormInputsWithLabelAndKey?.profilesVolunteersDefaultData
      }
      handleFileUpload={handleFileUpload}
      handleAttachmentsAndImgUpload={handleAttachmentsAndImgUpload}
      appliedFilter={appliedFilter}
    >
      <ProfileVolunteersTemplate {...(passAsProps as any)} />
    </ModalWrapper>
  );
};

export default ProfileVolunteersPage;
