...
import EnquiriesTemplate from '@/components/templates/EnquiriesTemplate';
...
const defaultTableData = tableWiseDefaultData?.enquiriesDefaultData;
...
const EnquiriesPage = () => {
  ...
  } = useDataTableLogics(defaultTableData, tableRelations?.enquiriesPage);
  ...
  return (
    <ModalWrapper
      ...
      columnWiseListForFilter={columnWiseListForFilter?.enquiriesDefaultData(
        tableHeader
      )}
      uploadFormInputsWithLabelAndKey={uploadFormInputsWithLabelAndKey?.enquiriesDefaultData(
        tableHeader
      )}
    ...
    >
      <EnquiriesTemplate {...(passAsProps as any)} />
    </ModalWrapper>
  );
};
