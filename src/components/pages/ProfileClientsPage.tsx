...
import ProfileClientsTemplate from '@/components/templates/ProfileClientsTemplate';
...
const defaultTableData = tableWiseDefaultData?.profilesClientsDefaultData;

const ProfileClientsPage = () => {
  const {
    appliedFilter,
    tableData,
    totalCount,
  ...
  } = useDataTableLogics(defaultTableData, tableRelations?.profilesClientsPage);
  ...
  return (
    <ModalWrapper
      ...
      uploadFormInputsWithLabelAndKey={
        uploadFormInputsWithLabelAndKey?.profilesClientsDefaultData
      }
      handleFileUpload={handleFileUpload}
      handleAttachmentsAndImgUpload={handleAttachmentsAndImgUpload}
      appliedFilter={appliedFilter}
    >
      <ProfileClientsTemplate {...(passAsProps as any)} />
    </ModalWrapper>
  );
};

export default ProfileClientsPage;
