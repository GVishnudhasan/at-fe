...
import { enquiriesServiceDataKeys } from '@/utils/tableDataUtils';
import type { TemplateType } from '@/utils/typeUtils';

const EnquiriesTemplate = ({
  appliedFilter = [],
  tableData,
  totalCount,
  selectedData,
    ...
    <div className="mx-auto mt-12 h-full w-[85%] md:w-[95%]">
      ...
      {!loading?.tableLoading || true ? (
        <TableSection
          ...
          tableDataKeys={enquiriesServiceDataKeys}
...
export default EnquiriesTemplate;
