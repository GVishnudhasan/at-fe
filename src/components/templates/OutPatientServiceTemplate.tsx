...
import { outPatientServiceDataKeys } from '@/utils/tableDataUtils';
import type { TemplateType } from '@/utils/typeUtils';

const OutPatientServiceTemplate = ({
  appliedFilter = [],
  tableData,
  totalCount,
  selectedData,
  ...
  return (
    <div className="mx-auto mt-12 h-full w-[85%] md:w-[95%]">
      <PageHeaderSection
        pageTitle="Out Patient Services"
      ...
      {!loading?.tableLoading || true ? (
        <TableSection
          ...
          tableDataKeys={outPatientServiceDataKeys}
...
export default OutPatientServiceTemplate;
