...
import { projectRescueDataKeys } from '@/utils/tableDataUtils';
import type { TemplateType } from '@/utils/typeUtils';

const ProjectRescueTemplate = ({
  appliedFilter = [],
  tableData,
  totalCount,
  selectedData,
    ...
    <div className="mx-auto mt-12 h-full w-[85%] md:w-[95%]">
      ...
      {!loading?.tableLoading || true ? (
        <TableSection
          ...
          tableDataKeys={projectRescueDataKeys}
...
export default ProjectRescueTemplate;
